...
const getTrainers=asyncHandler(async(req,res)=>{
  try{
    ...
    const numberOfTrainers = trainers.length;
      res.status(200).json({ trainers, numberOfTrainers, status: 200 });
    console.log(user);
  }catch(error){
...
export { signup, signin, logout, changePassword, forgotPassword,getTrainers };
